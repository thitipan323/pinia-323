        ...
        <div class="col-md-6">
            ...
            <div class="d-flex mt-3">
                <div class="btn-group me-auto">
                    <button class="btn btn-outline-success p-3" @click="increment_quantity()">เพิ่มสินค้า</button>
                    <button class="btn btn-outline-primary">{{ quantity }}</button>
                    <button class="btn btn-outline-danger p-3" @click="decrement_quantity()" :disabled="quantity == 1">ลบสินค้า</button>
                </div>
                <button class="btn btn-success p-3" @click="cart_store.add_cart_detail(product.id, product.price, quantity)">เพิ่มสินค้า</button>
            </div>
